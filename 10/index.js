...
const rightAnswer11 = document.getElementById("answer-right-11")
const wrongAnswer11 = document.getElementById("answer-wrong-11")
...
function onChangeHandler4(event) {
...
function onChangeHandler5(event) {
...
function onChangeHandler6(event) {
...
function onChangeHandler7(event) {
...
function onChangeHandler8(event) {
...
function onChangeHandler9(event) {
...
function onChangeHandler10(event) {
...
if (localStorage.getItem("answer-right-11") === data[10].answer) {
    document.getElementById("answer-11").value = data[10].answer
    document.getElementById("answer-11").disabled = true
    document.getElementById("check-11").disabled = true
    rightAnswer11.classList.add("answer-right-11")
}

function onChangeHandler11(event) {
    eleventhAnswer = event.value
}

function onClickHandler11() {
    if (data[10].answer === eleventhAnswer) {
        rightAnswer11.classList.add("answer-right-11")
        wrongAnswer11.classList.remove("answer-wrong-11")
        localStorage.setItem("answer-right-11", eleventhAnswer)
        rightAnswers++
        rightAnswersTag.textContent = rightAnswers
    } else {
        wrongAnswer11.classList.add("answer-wrong-11")
        rightAnswer11.classList.remove("answer-right-11")
    }

...
function onChangeHandler111(event) {
    firstAnswer = event.value
}

function onClickHandler111() {
...
function onChangeHandler222(event) {
    secondAnswer = event.value
}

function onClickHandler222() {
...
function onChangeHandler333(event) {
    thirdAnswer = event.value
}

function onClickHandler333() {
...
function onChangeHandler444(event) {
    fourthAnswer = event.value
}

function onClickHandler444() {
...
function onChangeHandler555(event) {
    fifthAnswer = event.value
}

function onClickHandler555() {
...
function onChangeHandler666(event) {
    sixthAnswer = event.value
}

function onClickHandler666() {
...
function onChangeHandler777(event) {
    seventhAnswer = event.value
}

function onClickHandler777() {
...
function onChangeHandler888(event) {
    eighthAnswer = event.value
}

function onClickHandler888() {
...
function onChangeHandler999(event) {
    ninthAnswer = event.value
}

function onClickHandler999() {
...
function onChangeHandler101010(event) {
    tenthAnswer = event.value
}

function onClickHandler101010() {
